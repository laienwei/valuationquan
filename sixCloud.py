...
for i in range(num):
    print(xx+i+1)
    print(sheet0.cell(row=xx+i+1, column=pub.column399088).value)
    sum0=sum0+sheet0.cell(row=xx+i+1, column=pub.column399088).value
    sheet.cell(row=p+i+1, column=3).value=sheet0.cell(row=xx+i+1, column=pub.column399088).value
...
print(sum0)
for i in range(num):
    sum0=sum0+sheet0.cell(row=xx+i+1, column=pub.column399378).value
    sheet.cell(row=p+i+1, column=3).value=sheet0.cell(row=xx+i+1, column=pub.column399378).value
    sheet.cell(row=p+i+1, column=1).value=p+i-1
    sheet.cell(row=p+i+1, column=2).value=lines[i]
    sheet.cell(row=p+i+1, column=4).value=sum0/(p+i-1)
wb.save(filename3)
